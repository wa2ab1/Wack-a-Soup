...
const int PIN_BUTTON[NUM_MOTORS] = {14, 15, 16, 17, 18};
bool lastHitButtonStates[NUM_MOTORS] = {HIGH, HIGH, HIGH, HIGH, HIGH};
...
void checkHitButtons() {
  for (int i = 0; i < NUM_MOTORS; i++) {
    ...
    if (currentBtnState == LOW && lastHitButtonStates[i] == HIGH) {
